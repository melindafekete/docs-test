...
sidebarTitle: "Introduction to feature flags"
description: "Feature flags allow you to release, test, and manage features and functionality across your application without changing the source code. Organizations use added control and flexibility to deliver more and higher quality features with reduced cost, time, and risk."
---
...
*The easiest way to explain why developers use feature flags is to understand the story of why [Ivar Østhus](https://github.com/ivarconr), our CTO, created the Unleash feature flag service in the first place. Here's Ivar in his own words:*
<Info>
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/how-feature-flags-work-8cb3a78f3a23e35281dc5cca78db9a24.png"
    alt="Diagram demonstrating the relationship between a CI/CD pipeline, an application, and its feature flags"
  />
</Frame>
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/xkcd-comic-spaceship-f38910b17144a3518a4c602508a3645a.png"
    alt="XKCD comic. Source: https://imgs.xkcd.com/comics/the_wrong_stuff.png"
  />
</Frame>
...
<CardGroup>
<Card title="Release flags" icon="flag" href="#release-flags" horizontal/>
<Card title="Experiment flags" icon="flask" href="#experiment-flags" horizontal/>
<Card title="Kill switches" icon="plug" href="#kill-switches" horizontal/>
<Card title="Operational flags" icon="terminal" href="#operational-flags" horizontal/>
<Card title="Permission flags" icon="shield" href="#permission-flags" horizontal/>
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/feature-flag-lifecycle-chart-1af0a5c9cbab0d070b2543c4f6c92587.png"
    alt="Pete Hodgson's taxonomy of feature flag types. Source: https://martinfowler.com/articles/feature-toggles.html"
  />
</Frame>
...
### Compliance with FedRAMP, SOC 2, ISO27001, Air-gap, and others[​](https://docs.getunleash.io/#compliance-with-fedramp-soc-2-iso27001-air-gap-and-others "Direct link to Compliance with FedRAMP, SOC 2, ISO27001, Air-gap, and others")
...
## Applying feature flag best practices with Unleash[​](https://docs.getunleash.io/#applying-feature-flag-best-practices-with-unleash "Direct link to Applying feature flag best practices with Unleash")
...
<CardGroup>
<Card title="Feature Flag Tutorials" icon="book-open" href="https://docs.getunleash.io/feature-flag-tutorials/use-cases/gradual-rollout" horizontal/>
<Card title="Best practices for using feature flags at scale" icon="grid" href="https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale" horizontal/>
<Card title="Best practices for building and scaling feature flags" icon="terminal" href="https://docs.getunleash.io/topics/feature-flags/feature-flag-best-practices" horizontal/>
<Card title="Try Unleash for Free" icon="sparkles" href="https://www.getunleash.io/pricing" horizontal/>
