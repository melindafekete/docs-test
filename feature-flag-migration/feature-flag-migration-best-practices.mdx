...
sidebarTitle: "Migrating from homegrown feature management solutions"
description: "Many large organizations have an existing feature management solution that they have outgrown and plan to migrate to a feature flag service."
---
...
<Steps>
<Step>
<Card title="Defining the scope of the feature flag migration" icon="terminal" href="#defining-the-scope-of-the-feature-flag-migration" horizontal/>
</Step>
<Step>
<Card title="Make the business case for feature flag migration" icon="briefcase" href="#make-the-business-case-for-feature-flag-migration" horizontal/>
</Step>
<Step>
<Card title="Planning Feature Flag Migration" icon="calendar" href="#planning-feature-flag-migration" horizontal/>
</Step>
<Step>
<Card title="Migration execution" icon="play" href="#migration-execution" horizontal/>
</Step>
<Step>
<Card title="Onboarding users" icon="users" href="#onboarding-users" horizontal/>
</Step>
</Steps>
