...
description: "This guide's purpose is to give you a conceptual overview of how Unleash works. It covers the various components that exist within our system and how they interact with each other and with external applications. The diagrams help you understand the fundamental building blocks, such as [projects](https://docs.getunleash.io/reference/projects), [environments](https://docs.getunleash.io/reference/environments), [variants](https://docs.getunleash.io/reference/strategy-variants) and of course, [feature flags](https://docs.getunleash.io/reference/feature-toggles)."
---

The end of this guide presents a [short use case, explaining how you might configure Unleash](https://docs.getunleash.io/understanding-unleash/#use-case) to start working with feature flags.
...
<CardGroup>
<Card title="API access tokens" icon="key" href="https://docs.getunleash.io/reference/api-tokens-and-client-keys" horizontal/>
<Card title="Projects" icon="folder" href="/reference/projects" horizontal/>
<Card title="Segments" icon="cube" href="https://docs.getunleash.io/reference/segments" horizontal/>
<Card title="Strategy types" icon="microchip" href="https://docs.getunleash.io/reference/activation-strategies" horizontal/>
<Card title="Tag types" icon="tag" href="https://docs.getunleash.io/reference/feature-toggles#tags" horizontal/>

</CardGroup>
- [Unleash context](https://docs.getunleash.io/reference/unleash-context) fields (including [custom context fields](https://docs.getunleash.io/reference/unleash-context#custom-context-fields))
- Users, [user groups](https://docs.getunleash.io/reference/rbac#user-groups) and [roles](https://docs.getunleash.io/reference/rbac)

## Projects

[**Projects**](/reference/projects) contain [feature flags](https://docs.getunleash.io/reference/feature-toggles) and their configurations, and a set of active [environments](https://docs.getunleash.io/reference/environments).

All Unleash instances must have at least one project at any given time. New instances get a project called “Default”.

[Pro](https://docs.getunleash.io/availability#plans) and [Enterprise](https://www.getunleash.io/pricing) customers can create, rename, and delete projects. [Open Source](https://www.getunleash.io/pricing) users have a single project called 'Default'.

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-environment-a51ce93daa041f0ca1e41e269d625884.png"
    alt="Unleash projects contain one or more environments"
  />
</Frame>
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-customer-tiers-de9282ccfd58965bdd2d7d07515ad70b.png"
    alt="Activating feature flags in environments"
  />
</Frame>
...
[Enterprise](https://www.getunleash.io/pricing) users can create and remove environments. [Open Source](https://www.getunleash.io/pricing) and [Pro](https://docs.getunleash.io/availability#plans) customers get access to two environments: **development** and **production.**

Environments are adjacent to [feature flags](https://docs.getunleash.io/reference/feature-toggles) in Unleash: neither one contains the other, but they come together to let you define activation strategies.

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-new-feature-rollout-448331b7984a97894ab3edb1a64feea8.png"
    alt="Constraints and activation strategies"
  />
</Frame>
<Note>
...
[**Feature flags**](https://docs.getunleash.io/reference/feature-toggles) are at the heart of Unleash’s functionality. Feature flags belong to projects and live next to project environments. In and of itself, a feature flag doesn’t do anything. You must assign [**activation strategies**](https://docs.getunleash.io/reference/activation-strategies) to it for it to start taking effect.

When creating a feature flag, you must assign a unique (across your Unleash instance) name, a [feature flag type](https://docs.getunleash.io/reference/feature-toggles#feature-flag-types), a [project](https://docs.getunleash.io/reference/projects) it belongs to, and an optional description. Everything except for the name can be changed later.

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-features-3637fadbe2e41e68c18162bde9b9f5dd.png"
    alt="A project containing an environment containing a feature flag configuration"
  />
</Frame>
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-strategy-03ead043c7db3c44c7021aae7749b7a0.png"
    alt="An environment containing a feature flag configuration with an activation strategy"
  />
</Frame>

[**Activation strategies**](https://docs.getunleash.io/reference/activation-strategies) (or just **strategies** for short) are the part of feature flags that tell Unleash **who should get a feature**. An activation strategy is assigned to \*\*one \*\*feature flag in \*\*one \*\*environment.

When you check a [feature flag](https://docs.getunleash.io/reference/feature-toggles) in an application, the following decides the result:
...
Unleash comes with a number of [built-in strategies](https://docs.getunleash.io/reference/activation-strategies). All strategies can be further augmented by [**strategy constraints**](https://docs.getunleash.io/reference/activation-strategies#constraints).

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-environments-strategies-ae4bec6c827caac3616219d3c47117be.png"
    alt="Feature flags across environments with different activation strategies"
  />
</Frame>

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-environments-strategies2-b9269bae9a4d5e0ebebda0b114344ae4.png"
    alt="Copying activation strategies"
  />
</Frame>

## Strategy constraints

[**Strategy constraints**](https://docs.getunleash.io/reference/activation-strategies#constraints) (or just **constraints**) help you fine-tune your strategies. They are an extra layer of prerequisites that help you narrow the audience of a strategy down. Strategy constraints are applied to [**activation strategies**](https://docs.getunleash.io/reference/activation-strategies).
...
You can define constraints on whatever properties you want in your [Unleash context](https://docs.getunleash.io/reference/unleash-context).

Constraints are applied to individual strategies and do not stay in sync with each other. When you need to have the same constraints applied to multiple strategies and need those constraints to stay in sync, use [**segments**](https://docs.getunleash.io/reference/segments).

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-constraint-c9ba9f6d669cd1d60abf42e20947e720.png"
    alt="Example of constraints applied to strategies"
  />
</Frame>

## Segments

[**Segments**](https://docs.getunleash.io/reference/segments) add extra functionality on top of [**strategy constraints**](https://docs.getunleash.io/reference/activation-strategies#constraints). A segment is a reusable collection of strategy constraints with a name and an optional description. When you apply a segment to a [strategy](https://docs.getunleash.io/reference/activation-strategies), the strategy will be evaluated as if all of the segment's constraints were applied to it.
...
Segments are only available to [Pro](https://docs.getunleash.io/availability#plans) and [Enterprise](https://www.getunleash.io/pricing) users.

<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-segments-1f4ddc5bf8d231b12f6c47bcbdc07904.png"
    alt="An example of segments"
  />
</Frame>

## Variants and feature flag payloads

By default, a [feature flag](https://docs.getunleash.io/reference/feature-toggles) in Unleash only tells you whether a feature is enabled or disabled, but you can also add more information to your flags by using [**feature flag variants**](https://docs.getunleash.io/reference/feature-toggle-variants). Variants also allow you to run [A/B testing experiments](https://docs.getunleash.io/feature-flag-tutorials/use-cases/a-b-testing).
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-variants-2f5bc23be7770a4c845cac8df1643994.png"
    alt="Variants prior to Unleash 4.21"
  />
</Frame>
...
<Frame>
  <img
    src="https://docs.getunleash.io/assets/images/anatomy-of-unleash-variants-environment-98ae2f2deedd43e15d865253cacd4c87.png"
    alt="Variants after version 4.21"
  />
</Frame>
...
You configure an [Unleash SDK for your server](https://docs.getunleash.io/reference/sdks) to communicate with Unleash. When rendering the page, you check the state of the new-color-scheme feature and render a different stylesheet based on the results.

In pseudocode (loosely based on the [Node.js SDK](https://docs.getunleash.io/reference/sdks/node)), that might look like this:
