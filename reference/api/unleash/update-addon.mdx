...
api: PUT https://docs.getunleash.io/api/admin/addons/{id}
contentType: application/json
---

<Note>
Passing `null` as a value for the description property will set it to an empty string.
</Note>
